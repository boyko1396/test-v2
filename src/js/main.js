...
$(document).ready(function() {    
    ...
    $('.tasks-field-wrap').click(function (e) {
        ...
        if (screenTest.find('.tasks-field-wrap').hasClass('active-item')) {
            screenTest.find('.bgwo6yki91-form-b__footer-btn-next').removeClass('disabled');
            return false;
        }
    });

    $('.bgwo6yki91-form-b__footer-btn-next').click(function (e) {
        var screenTest = $('.tab-pane.active');
        screenTestNext = screenTest.next();
        screenTestPrev = screenTest.prev();
        if (screenTest.find('.tasks-field-wrap').hasClass('active-item')) {
    ...
    $('.bgwo6yki91-form-b__footer-btn-prev').click(function (e) {
        var screenTest = $('.tab-pane.active');
        screenTestNext = screenTest.next();
        screenTestPrev = screenTest.prev();
        screenTest.removeClass('active');
    ...
    $('.js-modal-close').on('click', function (e) {
        ...
        $(this).parents('.vnqhutg-92').removeClass('is-show');
        e.preventDefault();
    });
});